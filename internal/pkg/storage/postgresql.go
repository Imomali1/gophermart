...
import (
	...
	"errors"
	"fmt"
	"github.com/Imomali1/gophermart/internal/pkg/utils"
...
func (s *dbStorage2) Update(ctx context.Context, batch entity.MetricsList) error {
	if len(batch) == 0 {
		return nil
	}
...
func (s *dbStorage2) GetOne(ctx context.Context, id, mType string) (entity.Metrics, error) {
...
func (s *dbStorage2) GetAll(ctx context.Context) (entity.MetricsList, error) {
...
func (s *dbStorage2) Ping(ctx context.Context) error {
	return s.pool.Ping(ctx)
}

func (s *dbStorage2) Close() {
	s.pool.Close()
}
